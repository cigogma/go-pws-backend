...
func (rtu *refreshTokenUsecase) GetUserByID(c context.Context, id uint) (domain.User, error) {
...
func (rtu *refreshTokenUsecase) ExtractIDFromToken(requestToken string, secret string) (uint, error) {
